    ...
    return (
        <div className={`${wrapperClassNames} map  overflow-hidden h-[219px] xl:h-[626px] px-5 lg:px-0`}>
            <div className='rounded-[20px] overflow-hidden w-full h-full relative'>
                <a href={`https://www.google.com/maps/dir/Current+Location/41.0628433,28.9841503`} className='absolute right-4 top-4 bg-white bg-opacity-80 border-2 border-[#DDDDDD] px-4 py-2 z-[1005] rounded-[10px] cursor-pointer text-xs' target="_blank">Nasıl Giderim</a>
